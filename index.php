...
<head>
    ...
    <title>
        <?php echo $Organizr->config['title']; ?>
    </title>
...
<body class="fix-header" data-active-tab="" tabIndex=0>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0 animated slideInDown">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-left">
                    ...
                    <li class=""><a class="dropdown-toggle waves-effect waves-light" onclick="closeCurrentTab(event);">
                            <i class="ti-close"></i></a></li>
                    <li class=""><a class="dropdown-toggle waves-effect waves-light" onclick="openInNewBrowserTab();">
                            <i class="ti-arrow-top-right"></i></a></li>
            ...
            <div class="dropdown-menu animated bounceInDown bg-danger text-white" id="main-org-error-container">
                <div class="mega-dropdown-menu row">
                    <div class="col-lg-12 mb-4">
                        <h3 class="mb-3 pull-left"><i class="fa fa-close text-white"></i>&nbsp; <span lang="en">An Error
                                Occurred</span>
                        </h3>
        ...
        <!-- help modal content -->
        <div class="modal fade help-modal-lg" tabindex="-1" role="dialog" aria-labelledby="help-modal-lg"
            aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title" id="help-modal-title" lang="en">Large modal</h4>
                    </div>
